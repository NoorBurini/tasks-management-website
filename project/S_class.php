...
<h1 style="font-family:lucida handwriting; color:#502474; margin-top:20px; margin-bottom:30px;" >Search By Class</h1>



<form method="post" action="<?php echo htmlspecialchars("S_class.php?user=".$user."&class=".$class); ?>">
<label for="class" style=" margin-left:15px;">Task Class</label>
...
<?php
	...
	if($conn->connect_error){
		...
		$sql=("SELECT * FROM tasks WHERE username='$user' and class='$class'");
		$res=$conn->query($sql);
		if($res->num_rows>0){
