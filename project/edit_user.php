...
<h1 style="font-family:lucida handwriting; color:#502474; margin-top:20px; margin-bottom:30px;" >Set New User Name</h1>
<?php
...
?>
<form method="post" action="<?php echo htmlspecialchars("setuser_V.php?result=".$result."&user=".$user); ?>">
<label for="name">Old User Name</label><br>
<input type="input" id="name" name="name" value="<?php echo $user; ?>" readonly>
<br>
