...
<h1 style="font-family:lucida handwriting; color:#502474; margin-top:20px; margin-bottom:30px;" >Search By Title</h1>



<form method="post" action="<?php echo htmlspecialchars("S_title.php?user=".$user."&title=".$title); ?>">
<label for="title" style=" margin-left:15px;">Task Title </label>
...
<?php
	...
	if($conn->connect_error){
		...
		$sql=("SELECT * FROM tasks WHERE username='$user' and title='$title'");
		$res=$conn->query($sql);
		if($res->num_rows>0){
